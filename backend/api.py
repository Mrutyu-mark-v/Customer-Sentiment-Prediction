...
def predict():
    ...
    try:
        # Check if the request contains a file (for bulk prediction)
        ...
        # Single text prediction - check for JSON data
            ...
            return jsonify({"error": "Invalid request. Please provide either a file or text input."}), 400
